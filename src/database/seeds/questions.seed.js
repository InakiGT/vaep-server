...
const openequestion_schema_1 = require("../schemas/openequestion.schema");
const theme_1 = require("../schemas/theme");
const mcquestion_1 = require("../schemas/mcquestion");
...
function seed() {
    return __awaiter(this, void 0, void 0, function* () {
        yield openequestion_schema_1.OpenQuestion.deleteMany();
        yield openequestion_schema_1.OpenQuestion.deleteMany();
        const administracioneficienteTheme = yield theme_1.Theme.findOne({ name: 'Clase 8: Administración Eficiente y Errores del Proceso' });
        const recursosMedidasTheme = yield theme_1.Theme.findOne({ name: 'Recursos, medidas, métricas e indicadores' });
        const elProblemaTheme = yield theme_1.Theme.findOne({ name: 'Clase 4: "El Problema"' });
        const estimacionTheme = yield theme_1.Theme.findOne({ name: 'Clase 10: Estimación' });
        const metodosTheme = yield theme_1.Theme.findOne({ name: 'Métodos de comunicación' });
        const themeAdministracionEficienteOpenWithIds = themeAdministracionEficiente.open.map(question => (Object.assign(Object.assign({}, question), { theme: administracioneficienteTheme === null || administracioneficienteTheme === void 0 ? void 0 : administracioneficienteTheme._id })));
        const themeAdministracionEficienteCloseWithIds = themeAdministracionEficiente.close.map(question => (Object.assign(Object.assign({}, question), { theme: administracioneficienteTheme === null || administracioneficienteTheme === void 0 ? void 0 : administracioneficienteTheme._id })));
        const themeRecursosMedidasOpenWithIds = themeRecursosMedidas.open.map(question => (Object.assign(Object.assign({}, question), { theme: recursosMedidasTheme === null || recursosMedidasTheme === void 0 ? void 0 : recursosMedidasTheme._id })));
        const themeRecursosMedidasCloseWithIds = themeRecursosMedidas.close.map(question => (Object.assign(Object.assign({}, question), { theme: recursosMedidasTheme === null || recursosMedidasTheme === void 0 ? void 0 : recursosMedidasTheme._id })));
        const themeElProblemaOpenWithIds = themeElProblema.open.map(question => (Object.assign(Object.assign({}, question), { theme: elProblemaTheme === null || elProblemaTheme === void 0 ? void 0 : elProblemaTheme._id })));
        const themeElProblemaCloseWithIds = themeElProblema.close.map(question => (Object.assign(Object.assign({}, question), { theme: elProblemaTheme === null || elProblemaTheme === void 0 ? void 0 : elProblemaTheme._id })));
        const themeEstimacionOpenWithIds = themeEstimacion.open.map(question => (Object.assign(Object.assign({}, question), { theme: estimacionTheme === null || estimacionTheme === void 0 ? void 0 : estimacionTheme._id })));
        const themeEstimacionCloseWithIds = themeEstimacion.close.map(question => (Object.assign(Object.assign({}, question), { theme: estimacionTheme === null || estimacionTheme === void 0 ? void 0 : estimacionTheme._id })));
        const themeMetodosComunicacionOpenWithIds = themeMetodosComunicacion.open.map(question => (Object.assign(Object.assign({}, question), { theme: metodosTheme === null || metodosTheme === void 0 ? void 0 : metodosTheme._id })));
        const themeMetodosComunicacionCloseWithIds = themeMetodosComunicacion.close.map(question => (Object.assign(Object.assign({}, question), { theme: metodosTheme === null || metodosTheme === void 0 ? void 0 : metodosTheme._id })));
        yield openequestion_schema_1.OpenQuestion.insertMany([...themeAdministracionEficienteOpenWithIds, ...themeRecursosMedidasOpenWithIds, ...themeElProblemaOpenWithIds, ...themeEstimacionOpenWithIds, ...themeMetodosComunicacionOpenWithIds]);
        yield mcquestion_1.MultipleChoiceQuestion.insertMany([...themeAdministracionEficienteCloseWithIds, ...themeRecursosMedidasCloseWithIds, ...themeElProblemaCloseWithIds, ...themeEstimacionCloseWithIds, ...themeMetodosComunicacionCloseWithIds]);
    });
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
